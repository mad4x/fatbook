    ...
    <div className="fixed inset-0 backdrop-blur-sm bg-slate-900/40 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-slate-950 rounded-xl shadow-2xl p-5 w-full max-w-2xl border border-gray-100 dark:border-slate-800 max-h-[80vh] overflow-y-auto">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Titolo Comunicazione</label>
            <input
              type="text"
              required
              className="w-full border border-gray-300 dark:border-slate-700 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 outline-none bg-white dark:bg-slate-950 text-gray-800 dark:text-slate-100"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Priorità</label>
              <select
                className="w-full border border-gray-300 dark:border-slate-700 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 outline-none bg-white dark:bg-slate-950 text-gray-800 dark:text-slate-100"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Categoria</label>
            <input
              type="text"
              className="w-full border border-gray-300 dark:border-slate-700 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 outline-none bg-white dark:bg-slate-950 text-gray-800 dark:text-slate-100"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Tag (separati da virgola)</label>
            <input
              type="text"
              className="w-full border border-gray-300 dark:border-slate-700 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 outline-none bg-white dark:bg-slate-950 text-gray-800 dark:text-slate-100"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Autore</label>
            <input
              type="text"
              required
              className="w-full border border-gray-300 dark:border-slate-700 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 outline-none bg-white dark:bg-slate-950 text-gray-800 dark:text-slate-100"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Allegati (URL separati da virgola, facoltativo)</label>
            <input
              type="text"
              className="w-full border border-gray-300 dark:border-slate-700 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 outline-none bg-white dark:bg-slate-950 text-gray-800 dark:text-slate-100"
          ...
          <div>
            ...
            {isEditMode && existingEmbeddedAttachments.length > 0 && (
              <div className="mt-2 space-y-1">
                <p className="text-xs text-gray-600 dark:text-slate-400">File già allegati ({existingEmbeddedAttachments.length})</p>
                <ul className="space-y-1">
                  {existingEmbeddedAttachments.map((attachment, index) => (
                    <li
                      key={`existing-file-${index}`}
                      className="flex items-center justify-between gap-2 text-xs bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded px-2 py-1"
                    >
                      ...
                      {onRemoveExistingAttachment && (
                        <button
                          ...
                          className="text-red-600 hover:text-red-700 dark:text-red-300 dark:hover:text-red-200 font-medium whitespace-nowrap"
                        >
                          Rimuovi
                        </button>
                      )}
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <button
              ...
              className="px-4 py-2 text-gray-700 bg-gray-100 hover:bg-gray-200 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 rounded-lg font-medium transition"
            >
